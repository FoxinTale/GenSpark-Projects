...
public class World extends Game {
    ...
    public static Goblin findGoblinAtPlayerPosition() {
        ...
        for (Goblin goblin : goblinList) {
            ...
            if (g.getX() == Game.getPlayer().getX() && g.getY() == Game.getPlayer().getY()) {
                return goblin;
            }
        }
        return null;
    ...
    public static void setPositions() {
        playerGoblinCheck();
        GUI.boxes[Game.getPlayer().getX()][Game.getPlayer().getY()].setText("O");

        for (Goblin goblin : goblinList) {
            GUI.boxes[goblin.getX()][goblin.getY()].setText("G");
        }
    }

    public static boolean playerGoblinCheck() {
        return GUI.boxes[Game.getPlayer().getX()][Game.getPlayer().getY()].getText().equals("G");
    }
